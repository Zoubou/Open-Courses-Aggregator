...
- **📊 Ομαδοποίηση Μαθημάτων**: Clustering με K-means για ομοιότητα περιεχομένου
...
│   ├── courseClusters.py          # K-means clustering algorithm
